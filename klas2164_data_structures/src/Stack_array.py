...
class Stack:
    ...
    def is_empty(self):
        ...
        -------------------------------------------------------
        """
        # Returns boolean based on length of values
    ...
    def combine(self, source1, source2):
        ...
        while source1._values or source2._values:
            if source1._values:
                target.append(source1._values.pop())
            if source2._values:
                target.append(source2._values.pop())

        target.reverse()
        self._values.extend(target)
    ...
    def reverse(self):
        ...
        target = []
        while self._values:
            target.append(self._values.pop())
        for item in target:
