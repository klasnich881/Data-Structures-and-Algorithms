    ...
    def gnome_sort(a):
        ...
        while pos < n:
            if pos == 0 or a[pos] >= a[pos - 1]:
                # If we're at the start or the current element is greater than
                # or equal to the previous element, move to the next element.
                pos += 1
            else:
                # Swap the current element with the previous one and move one step back.
