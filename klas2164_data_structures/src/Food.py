...
class Food:
    ...
    def origins():
        ...
        # your code here
        string = []
        for orig in range(len(Food.ORIGIN)):
            string.append(f'{orig:2d} {Food.ORIGIN[orig]}')
...
"""
    ...
    def __eq__(self, target):
        ...
        """
        return (
            self.name == target.name and
            self.origin == target.origin and
            self.is_vegetarian == target.is_vegetarian and
            self.calories == target.calories
        )
