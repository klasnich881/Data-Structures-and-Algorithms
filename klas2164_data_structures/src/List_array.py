...
class List:
    ...
    def _linear_search(self, key):
        ...
        return -1 if i == len(self._values) else i
    ...
    def combine(self, source1, source2):
        ...
        while not source1.is_empty() and not source2.is_empty():
            # Append value from source1
            self._values.append(source1.pop(0))
            # Append value from source2
            self._values.append(source2.pop(0))

            # If source1 or source2 still has elements, append them to the target
    ...
    def insert(self, i, value):
        ...
        -------------------------------------------------------
        """
        # Check to see if i parameter is valid
        if abs(i) > len(self._values):
            if i > 0:
            ...
            self._values = self._values[:i] + [deepcopy(value)] \
                + self._values[i:]
    ...
    def prepend(self, value):
        ...
        """
        # Your code here
        self._values.prepend(deepcopy(value))
    ...
    def remove_front(self):
        ...
        if len(self._values) > 0:
            ...
            raise Exception(f'Cannot remove from an empty list')
    ...
    def split(self):
        ...
        target1 = List()
        target1._values = self._values[:middle + 1]

        target2 = List()
        target2._values = self._values[middle + 1:]
    ...
    def split_key(self, key):
        ...
        target1 = List()
        target2 = List()
        for u in range(len(self._values)):
            if self._values[u] < key:
                target1._values.append(self._values[u])
            else:
                target2._values.append(self._values[u])
        self._values = []
        return target1, target2
    ...
    def union(self, source1, source2):
        ...
        """
        # Your code here
        for u in range(len(source1)):
            if source1[u] not in self._values:
                self._values.append(source1[u])
        for b in range(len(source2)):
            if source2[b] not in self._values:
                self._values.append(source2[b])
